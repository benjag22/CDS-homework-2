...
// private:
	...
	extern MemoryManager _memMgr; 	  /* Holds dynamic memory reserve for words. */

	extern unsigned long TAM_HASH;   /* # entries in the hash table    */
	extern unsigned long NumElem;    /* # elements already added to the hash table*/
...
// public:
	extern t_word  *hash;     		  /* holds a hashTable of words  */
